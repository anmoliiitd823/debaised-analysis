...
def hello_http(request):
    ...
    if intent == 'show':
        query_result = show(query_table_dataframe,
                                     slices=slices_list,
                                     metric=metric,
...
def get_all_column_labels(rangeA1Notation):
    """
    This function returns a list which gives all the column labels present
...
def get_all_row_labels(rangeA1Notation):
    """
    This function returns a list which gives all the row labels present
